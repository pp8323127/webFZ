...
public class DeliverMail {
	 ...
	 * 
	 */
	public void Deliver(String subject, String receiverEmpno, Object object)
			throws Exception {
		...
		try {
			...
			if (!"null".equals(receiverEmpno) && receiverEmpno != null) {
				...
				msg.setContent(object, "text/plain;charset=big5");
				Transport.send(msg);
	...
	public static void main(String args[]) 
	{
		...
		try 
		{
			dm.DeliverWithSenderName("併房申請確認通知", "640790","你的xxxxxx xxxxxx xxxxxx", "640790", "Big5");
