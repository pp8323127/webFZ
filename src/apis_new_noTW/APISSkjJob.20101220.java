...
{   
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
	        ...
	        c.getAPISFlt("2010/11/07","5392","ANC");
	        ArrayList apisfltAL = new ArrayList();
...
//	    	stmt = conn.createStatement();	
	    	...
	    	sql = " SELECT flt_num fltno,  fdate,  dpt, arv, carrier, " +
	    		  ...
	    		  " WHERE str_port_local between To_Date('"+fdate+" 00:01','yyyy/mm/dd hh24:mi') " +
...
//	    	stmt = conn.createStatement();	
	    	...
	    	sql = " SELECT staff_num empno,  carrier,  flt_num fltno,  fdate,  lname, nvl(fname,' ') fname, nation, birth, passport, " +
	    		  ...
	    		  " nvl(birthcity,' ') birthcity, tvlstatus, passcountry, passexp, Nvl(certno,'') certno, Nvl(certctry,'') certctry, " +
...
//	    	stmt = conn.createStatement();	
	    	...
	    	sql = " SELECT rtrim(ltrim(carrier)) carrier,  rtrim(ltrim(fltno)) fltno, " +
	    		  ...
	    		  " rtrim(ltrim(nation)) nation, substr(rtrim(ltrim(birth)),3) birth, rtrim(ltrim(passport)) passport, " +
	    		  ...
	    		  " substr(rtrim(ltrim(passexp)),3) passexp, rtrim(ltrim(issue)) passcountry, " +
...
//	         }
	         else if("USA".equals(portobj1.getCtry()))
	         {
	...
	//         }
		...
		//System.out.println("crew_cnt"+apisdetailAL.size()+" ** "+ telex_page_start +"  ** "+telex_page_end);             
			         ...
			         {         
				         ...
				         txtSB.append("QD"+qd_str+"\r\n");
				         txtSB.append("."+obj.getDpt()+"TT"+obj.getCarrier()+"\r\n");
				         txtSB.append("UNA:(.? )"+"\r\n");
				         if(ischina==true)
				         {						             
//				             txtSB.append("UNB(UNOA:4(TPETTCI:"+obj.getCarrier()+"(CNADAPIS:ZZ("+time1+"("+time2+"((APIS) "+"\r\n");
//				             txtSB.append("UNG(PAXLST(CHINA? AIRLINES:"+obj.getCarrier()+"(CNADAPIS:ZZ("+time1+"("+time2+"(UN(D:02B)"+"\r\n");
...
//				             {//cargo passenger include resiaddr1~5
				             	...
				             	{
				             	   txtSB.append("NAD(FM((("+apisdetailobj.getLname().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)").replaceAll("[.]","?.")+":"+apisdetailobj.getFname().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)").replaceAll("[.]","?.")+"("+apisdetailobj.getResiaddr1().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)")+"("+apisdetailobj.getResiaddr2().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)")+"(("+apisdetailobj.getResiaddr4().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)")+"("+apisdetailobj.getResiaddr5().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)")+")"+"\r\n");
				             	}
				             	else
				             	{
				                   txtSB.append("NAD(FM((("+apisdetailobj.getLname().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)").replaceAll("[.]","?.")+":"+apisdetailobj.getFname().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)").replaceAll("[.]","?.")+"("+apisdetailobj.getResiaddr1().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)")+"("+apisdetailobj.getResiaddr2().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)")+"("+apisdetailobj.getResiaddr3().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)")+"("+apisdetailobj.getResiaddr4().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)")+"("+apisdetailobj.getResiaddr5().replaceAll("[?]","??").replaceAll(" ","? ").replaceAll("[(]","?(").replaceAll("[)]","?)")+")"+"\r\n");
				             	}
//				             }
//				             else
//				             {
...
//			       qd_str = " CGKBCXH TPEWGCI";
//			   }
			   else if("USA".equals(portobj2.getCtry()))
			   {
			       qd_str = " DCAUCCR TPEWGCI";
			   }
