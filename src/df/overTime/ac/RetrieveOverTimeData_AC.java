...
public class RetrieveOverTimeData_AC
{
    ...
    public static void main(String[] args)
    {
        ...
        RetrieveOverTimeData_AC rot = new RetrieveOverTimeData_AC("2011", "12");
...
//            	  "						 AND  ( dps.duty_cd = 'FLY' or dps.duty_cd='TVL') " + 
            	  "						 AND  ( dps.duty_cd = 'FLY') " + //in case ECM or ACM 不計算
...
//            	  "              AND  ( dps.duty_cd = 'FLY' or dps.duty_cd='TVL') " +
            	  ...
            	  "       AND r.delete_ind = 'N' " + 
//            	  "       AND (r.duty_cd = 'FLY' or r.duty_cd = 'TVL') " +
            	  "       AND (r.duty_cd = 'FLY') " +
            	  "       AND   r.staff_num||''  like '6%' " + 
            	  //add on 2009/02/11*********
