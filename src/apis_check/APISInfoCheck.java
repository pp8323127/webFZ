...
public class APISInfoCheck
{
    ...
    public static void main(String[] args)
    {
        ...
        apis.checkEngName("A");
        apis.checkNation("B");
        apis.checkPassport("C");
        apis.check2ndDocName("D");
        apis.check2ndDocNation("E");
        apis.check2ndDoc("F");        
        apis.checkCHN("G");
        apis.checkRAT("H");        
        apis.checkAddr("I");
...
//        String cc = "lee@china-airlines.com,christi@china-airlines.com,davidjen@china-airlines.com,yi-chuan.kang@china-airlines.com,pierce@china-airlines.com,tpecsci@cal.aero";
        ...
        mailContent.append("********************FOR EXPORT EXCEL********************\r\n");  
        mailContent.append("**      將以下資料複製至notepad並存檔成csv附檔格式即可        **\r\n");  
        mailContent.append("************************************************************\r\n");  
        mailContent.append(apis.getSB2());
...
//  check ename cab -> egtcbas.ename  cop-> crew_v.other_first_name  cop-> crew_v.other_surname
    public String checkEngName(String seq)
    {   
        Statement stmt = null;
        ResultSet rs = null;
       ...
       try
       {
	    	...
	    	sql = " SELECT trim(empno) empno, cabin FROM ( " +
...
//System.out.println("ename = "+sql);	    	
	    	...
	    	while (rs.next())
	    	{
	    	    ...
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getUnitDsc(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        sb2.append("English Name Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getUnitDsc(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	    }
	    	    else
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        sb2.append("English Name Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getRank(rs.getString("empno"))+","+hr.getFleet(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	    }
	    	}
	        sb.append("**********************************************************\r\n");  
	    	sb.append("\r\n");
...
//  check Nation cab -> egtcbas.nation  cop-> crew_v.nationality_cd
    public String checkNation(String seq)
    {   
        Statement stmt = null;
        ResultSet rs = null;
        Connection conn = null;
...
//System.out.println("nation = "+sql);	    	
	    	...
	    	while (rs.next())
	    	{
	    	    ...
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getUnitDsc(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        sb2.append("1st Nation Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getUnitDsc(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	    }
	    	    else
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        sb2.append("1st Nation Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getRank(rs.getString("empno"))+","+hr.getFleet(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	    }
	    	}
	    	sb.append("**********************************************************\r\n");  
	    	sb.append("\r\n");
    ...
    public String checkPassport(String seq)
    {   
        Statement stmt = null;
        ResultSet rs = null;
        Connection conn = null;
...
//System.out.println("passport = "+sql);	    	
	    	...
	    	while (rs.next())
	    	{
	    	    ...
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getUnitDsc(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");	    	    
	    	        sb2.append("Passport Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getUnitDsc(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	    }
	    	    else
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        sb2.append("Passport Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getRank(rs.getString("empno"))+","+hr.getFleet(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	    }
	    	}
	    	sb.append("**********************************************************\r\n");  
	    	sb.append("\r\n");
...
//  check 2nd Doc Name cab -> egtpass  cop-> dftpass
    public String check2ndDocName(String seq)
    {   
        Statement stmt = null;
        ResultSet rs = null;
        Connection conn = null;
...
//System.out.println("2nd doc name = "+sql);	    	
	    	...
	    	while (rs.next())
	    	{
	    	    ...
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getUnitDsc(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        sb2.append("2nd Document Name Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getUnitDsc(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	    }
	    	    else
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        sb2.append("2nd Document Name Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getRank(rs.getString("empno"))+","+hr.getFleet(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	    }
	    	}
	    	sb.append("**********************************************************\r\n");  
	    	sb.append("\r\n");
...
//  check 2nd Doc Nation cab -> egtpass  cop-> dftpass
    public String check2ndDocNation(String seq)
    {   
        Statement stmt = null;
        ResultSet rs = null;
        Connection conn = null;
...
//System.out.println("check2ndDocNation = "+sql);	    	
	    	...
	    	while (rs.next())
	    	{
	    	    ...
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getUnitDsc(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        sb2.append("2nd Document Issue Nation Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getUnitDsc(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	    }
	    	    else
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        sb2.append("2nd Document Issue Nation Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getRank(rs.getString("empno"))+","+hr.getFleet(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");	    	        
	    	    }
	    	}
	    	sb.append("**********************************************************\r\n");  
	    	sb.append("\r\n");
...
//  check 2nd Doc cab -> egtpass  cop-> dftpass
    public String check2ndDoc(String seq)
    {   
        Statement stmt = null;
        ResultSet rs = null;
        Connection conn = null;
       ...
       try
       {
	    	...
	    	sql = " SELECT trim(empno) empno, issue_nation, doc_tp FROM egtpass " +
...
//System.out.println("2nd doc = "+sql);	    	
	    	...
	    	while (rs.next())
	    	{
	    	    ...
	    	    sb.append("      "+"CABIN "+ rs.getString("empno")+" "+rs.getString("issue_nation")+"  "+hr.getCname(rs.getString("empno"))+" "+hr.getUnitDsc(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+" ");	   
	    	    sb2.append("2nd Document Validity Check,"+"CABIN,"+ rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getUnitDsc(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+",");
	    	   
	    	    
	    	    if("P".equals(rs.getString("doc_tp")))
	    	    {
	    	        sb.append(rs.getString("issue_nation")+" PASSPORT 效期已失效\r\n");
	    	        sb2.append(rs.getString("issue_nation")+" PASSPORT 效期已失效\r\n");
	    	    }
	    	    
	    	    if("C".equals(rs.getString("doc_tp")))
	    	    {
	    	        sb.append(rs.getString("issue_nation")+" Green Card 效期已失效\r\n");
	    	        sb2.append(rs.getString("issue_nation")+" Green Card 效期已失效\r\n");
	    	    }
	    	}
...
//System.out.println("2nd doc = "+sql);	    	
		  	...
		  	while (rs.next())
		  	{
		  	    sb.append("      "+"PILOT "+ rs.getString("empno")+" "+rs.getString("issuectry")+"  "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+" ");   
		  	    sb2.append("2nd Document Validity Check,"+"PILOT,"+ rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getRank(rs.getString("empno"))+","+hr.getFleet(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+",");
		  	    if("P".equals(rs.getString("doctype")))
		  	    {
		  	        sb.append(rs.getString("issuectry")+" PASSPORT 效期已失效\r\n");
		  	        sb2.append(rs.getString("issuectry")+" PASSPORT 效期已失效\r\n");
		  	    }
		  	    
		  	    if("C".equals(rs.getString("doctype")))
		  	    {
		  	        sb.append(rs.getString("issuectry")+" GREEN CARD 效期已失效\r\n");
		  	        sb2.append(rs.getString("issuectry")+" GREEN CARD 效期已失效\r\n");
		  	    }
		  	}
		  	sb.append("**********************************************************\r\n");  
	    	sb.append("\r\n");
    ...
    public String checkCHN(String seq)
    {   
        Statement stmt = null;
        ResultSet rs = null;
        Connection conn = null;
       ...
       try
       {
	    	...
	    	sql = " SELECT trim(empno) empno, cabin, licence_num FROM ( " +
...
//System.out.println("chn = "+sql);	    	
	    	...
	    	while (rs.next())
	    	{
	    	    ...
	    	    {
	    	        //無需檢核該員台胞証
	    	        if(!"638592".equals(rs.getString("empno")))
	    	        {
		    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getUnitDsc(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
		    	        sb2.append("CHN VISA Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getUnitDsc(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        }
	    	    }
	    	    else
	    	    {
	    	        ...
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");
	    	        sb2.append("CHN VISA Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getRank(rs.getString("empno"))+","+hr.getFleet(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
...
//  check PILOT RAT
    public String checkRAT(String seq)
    {   
        Statement stmt = null;
        ResultSet rs = null;
        Connection conn = null;
...
//System.out.println("rat = "+sql);	    	
	    	...
	    	{
	    	    sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");	    	    
	    	    sb2.append("RAT Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getRank(rs.getString("empno"))+","+hr.getFleet(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	}
	    	sb.append("**********************************************************\r\n");  
	    	sb.append("\r\n");
	    	returnstr = "Y";    	
...
//  check dfttsa.address
    public String checkAddr(String seq)
    {   
        Statement stmt = null;
        ResultSet rs = null;
        Connection conn = null;
...
//System.out.println("addr = "+sql);	    	
	    	...
	    	{
	    	    sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");    	    
	    	    sb2.append("Resident Address INFO Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getRank(rs.getString("empno"))+","+hr.getFleet(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	}
	    	sb.append("**********************************************************\r\n");  
	    	sb.append("\r\n");
	    	returnstr = "Y";    	
...
//  check crew profile
    public String checkProfile(String seq)
    {   
        Statement stmt = null;
        ResultSet rs = null;
        Connection conn = null;
...
//System.out.println("profile = "+sql);	    	
	    	...
	    	while (rs.next())
	    	{
	    	    ...
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");	    	    
	    	        sb2.append("Profile Check,"+rs.getString("cabin")+","+rs.getString("empno")+","+hr.getCname(rs.getString("empno"))+","+hr.getRank(rs.getString("empno"))+","+hr.getFleet(rs.getString("empno"))+","+hr.getBase(rs.getString("empno"))+"\r\n");
	    	    }
	    	    else
	    	    {
	    	        sb.append("      "+rs.getString("cabin")+"  "+rs.getString("empno")+" "+hr.getCname(rs.getString("empno"))+" "+hr.getRank(rs.getString("empno"))+" "+hr.getFleet(rs.getString("empno"))+" "+hr.getBase(rs.getString("empno"))+"\r\n");    
