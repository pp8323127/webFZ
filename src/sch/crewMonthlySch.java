...
public class crewMonthlySch {
	...
	private rankObj staffRankObj = null;
	 ...
	 String rs = ms.schFile("2006"+"05", "TPE", "", "X");
	 System.out.println(new java.util.Date());
	...
	public String schFile(String fmm, String base, String rank, String sk) {
		...
		try {
			fw = new FileWriter("/apsource/csap/projfz/webap/" + fmm + base
					+ rank + sk + ".csv", false);
//			fw = new FileWriter(path + fmm + base + rank + sk + ".csv", false);
...
//            conn = DriverManager
			...
			else if (!"X".equals(sk)) 
			{
			 ...
			 "(SELECT Max(Nvl(exp_dt,to_date('"+fmm+"010000','yyyymmddHH24MI'))) exp_dt, staff_num, base FROM crew_base_v WHERE (exp_dt >= to_date('"+fmm+"010000','yyyymmddHH24MI') or exp_dt is NULL) GROUP BY staff_num, base) b, " +
...
//			 "and c.staff_num=b.staff_num and b.base=? and (b.exp_dt >=	 sysdate or b.exp_dt is null) " +
			 "and c.staff_num=b.staff_num and b.base=? and (b.exp_dt >=	 to_date('"+fmm+"010000','yyyymmddHH24MI') or b.exp_dt is null) " +
...
//			 "from roster_v r, crew_v c, crew_base_v b, rank_tp_v rt, crew_rank_v cr, crew_spec_skills_v sk " +
			 "from roster_v r, crew_v c, (SELECT Max(Nvl(exp_dt,to_date('"+fmm+"010000','yyyymmddHH24MI'))) exp_dt, staff_num, base FROM crew_base_v WHERE (exp_dt >= to_date('"+fmm+"010000','yyyymmddHH24MI') or exp_dt is NULL) GROUP BY staff_num, base) b, " +
			 "rank_tp_v rt, crew_rank_v cr, crew_spec_skills_v sk " +			 
...
//System.out.println("line 5");				    
					...
					if (smm == inmm) 
					{
//System.out.println("smm  "+smm+" sch[sdd - 1] "+sch[sdd - 1]+" position "+sch[sdd - 1].indexOf(" "));				    
...
//System.out.println("line 8");				
			...
			// wstring = wstring.substring(0, wstring.length()-1) +
			// ","+cr+","+rankCd+"\n";
//System.out.println("wstring2 = "+wstring);	
