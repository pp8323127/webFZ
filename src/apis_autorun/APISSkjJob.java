...
//	    		  " AND ctry IN ('USA','CHINA','CANADA','JAPAN','KOREA','INDIA','UK') " +
	    		  " AND ctry IN ('USA','CHINA','CANADA','JAPAN','KOREA','INDIA','NEW ZEALAND','TAIWAN','UK','NETHERLANDS') " +
...
//	        cn.setORT1FZUser();
	    	...
	    	sql = " SELECT staff_num empno,  carrier,  flt_num fltno,  fdate,  lname, " +
	    		  " nvl(fname,' ') fname, nation, birth, passport, passport2, gender,  dpt, arv, occu, " +
	    		  " to_char(str_port_local,'yyyy/mm/dd hh24:mi') str_port_local , " +
	    		  " to_char(end_port_local,'yyyy/mm/dd hh24:mi') end_port_local , " +  
...
//	         }
	         if("USA".equals(portobj1.getCtry()))
	         {
	             ...
	             //暫停發送
	             //19APR/CI5385/MIA/ATL	(Local date)  
	             //20APR/CI5385/MIA/ATL	(Local date)
//	             if("MIA".equals(obj.getDpt()) && "ATL".equals(obj.getDpt()) && "5385".equals(obj.getFltno()) && ("110419".equals(obj.getFdate()) | "110420".equals(obj.getFdate())))
//	             {
//	                 qd_str = "";
//	             }
	         }
