...
/**
 * PeriodDailyCheckObj ,修改自DailyCheckObj,用於 Flight Period Query
 * 
 * 
 * @author cs66
 * @version 1.0 2006/6/13
 * @version 2.0 2007/11/20
 * @version 2.1 2008/02/27 新增實際起飛時間（含hhmm)
 * 
 * Copyright: Copyright (c) 2006
 */

public class PeriodDailyCheckObj implements Serializable {
	...
	private String actStrDt;//實際起飛時間 yyyy/mm/dd hh24mi
	
	private int actCrewNum;// 實際組員配置人數
	private boolean planEqualsActCrew = true;// 預估配置人數等於實際配置人數
	...
	public int getActCrewNum() {
		return actCrewNum;
	}
	public void setActCrewNum(int actCrewNum) {
		this.actCrewNum = actCrewNum;
	}
	public boolean isPlanEqualsActCrew() {
		return planEqualsActCrew;
	}
	public void setPlanEqualsActCrew() {
		try{
			if(getActCrewNum() != getTotalPln())
				this.planEqualsActCrew = false;	
		}catch(Exception e){
			this.planEqualsActCrew = false;	
		}
	...
	public String getActStrDt() {
		return actStrDt;
	}
	public void setActStrDt(String actStrDt) {
		this.actStrDt = actStrDt;
	}
