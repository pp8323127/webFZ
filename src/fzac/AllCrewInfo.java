...
/**
 * AllCrewInfo 取得組員個人基本資料.(FOR不在職者)
 * 
 * @author cs66
 ...
 */
public class AllCrewInfo {

	// public static void main(String[] args) {
	// CrewInfo c = new CrewInfo("25801");
	 ...
	 */
	public AllCrewInfo(String empno) {
		this.empno = empno;
		try {
			SelectData();
...
//		ConnAOCI cna = new ConnAOCI();
		...
		try {
			...
			while (rs.next()) {
				...
				o1.setCname(UnicodeStringParser.removeExtraEscape(rs
						.getString("cname")));
