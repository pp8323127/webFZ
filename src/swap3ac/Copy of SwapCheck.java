...
public class SwapCheck 
{
        public static void main(String[] args) {
            SwapCheck s = new SwapCheck("10115","4625","7810","6930");
...
//             System.out.println(s.getErrorMsg());
    ...
    private void setErrorMsg(int errorCode) {
        ...
        case 1:
            ...
            break;
        case 2:
            errorMsg = "ビ叫传惠传玡,<br>砆传传惠ざ100籔70ぇ丁";
//            errorMsg = "ビ叫惠传耕计,<br>砆传传惠ざ95籔70ぇ丁";
        ...
        case 3:
            ...
            break;
        case 4:
            errorMsg = "ビ叫传惠ざ100籔70ぇ丁.<br>砆传传惠传玡";
//            errorMsg = "ビ叫传惠ざ95籔70ぇ丁.<br>砆传惠传耕计";
            break;
        case 5:
//            errorMsg = "ビ叫籔砆传,传А惠ざ95籔70ぇ丁.";
            errorMsg = "ビ叫籔砆传,传А惠ざ100籔70ぇ丁.";
            break;
        case 6:
            errorMsg = "ビ叫传惠ざ100籔70ぇ丁.<br>砆传传惠传玡";
