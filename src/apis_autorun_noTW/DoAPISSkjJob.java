...
//		   	         	if("USA,CHINA,CANADA,KOREA,INDIA,NEW ZEALAND,TAIWAN".indexOf(portobj1.getCtry())>=0)
		   	            if("USA,CHINA,CANADA,KOREA,INDIA,NEW ZEALAND".indexOf(portobj1.getCtry())>=0)
		   	         	{
		   	         	    ifneedapis = true ;
		   	         	}
		   	         	
		   	         	if("USA,CHINA,JAPAN,CANADA,KOREA,INDIA,NEW ZEALAND".indexOf(portobj2.getCtry())>=0)
		   	         	{
		   	         	    ifneedapis = true ;
		   	         	}
