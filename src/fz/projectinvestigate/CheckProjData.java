 ...
 */
public class CheckProjData {

	 public static void main(String[] args) 
	 {
	     CheckProjData chksfly = new CheckProjData("2008/11/05","0052", "SYDTPE", "631451");
...
//		 }
	 ...
	 *            座艙長員工號	 
	 */
	public CheckProjData(String fdate, String fltno, String sect,String purserEmpno) 
	{
		this.fdate = fdate;
		this.fltno = fltno;
		this.sect = sect;
	...
	{ 
		...
		try 
		{
			...
			sql = " select count(*) c FROM egtprpj  WHERE fltdt = To_Date(?,'yyyy/mm/dd') " +
	...
	{ 
		...
		try 
		{
			...
			sql = " delete FROM egtprpj  WHERE fltdt = To_Date(?,'yyyy/mm/dd') " +
				  " AND fltno = ? AND sect = ?  and empno = ? ";
			pstmt = conn.prepareStatement(sql);
			pstmt.setString(1, fdate);
			pstmt.setString(2, fltno);
