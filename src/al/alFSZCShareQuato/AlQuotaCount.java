...
{   
        ...
        {            
			...
			con = dbDriver.connect(cdb.getConnURL(), null);
                ...
                //****************************
                //modify by Betty
                if("TPE ZC".equals(qitem) || "TPE FS".equals(qitem))
                {
                    aa = "select sum(quota) quota from egtquota where yy||'-'||mm='"+myday+"' and (qitem='TPE FS' or qitem='TPE ZC')";
                }
                else
                {               
        			...
        			"to_char(a.offedate,'yyyy-mm') = '" + myday + "') and (a.remark <> '*' or a.remark is null)";
                        ...
                        else if (station.equals("TPE"))//TPE CREW (FA, FS)
                        {
                                if (jobitem.equals("FA"))
                                {
                                    	...
                                    	"from EGTOFFS a, EGTCBAS b " + 
                                    	"where a.empn = b.empn and b.station = 'TPE' and " +
                                    	"(b.jobno = " + jobno1 + " or b.jobno = "+jobno2+") and NVL(b.specialcode, 'N') not in ('J','K') and " +
                                ...
                                else if (jobitem.equals("FS"))//FS
                                {
                                    	...
                                    	//Modify by betty
                                    	//"(b.jobno = " + jobno1 + " or b.jobno = "+jobno2+") and NVL(b.specialcode, 'N') not in ('J','K') and " +
                                    	"(b.jobno = " + jobno1 + " or b.jobno = "+jobno2+" or b.jobno='95') and NVL(b.specialcode, 'N') not in ('J','K') and " +
                                    	"a.offtype = '0' and (to_char(a.offsdate,'yyyy-mm') <= '" + myday + "' and " +
                                    	"to_char(a.offedate,'yyyy-mm') >= '" + myday + "') and (a.remark <> '*' or a.remark is null)";
                                }
                                else //ZC
                                {                                      
                                    	...
                                    	"from EGTOFFS a, EGTCBAS b " + 
                                    	"where a.empn = b.empn and b.station = 'TPE' and " +
                                    	//"b.jobno = '95'  and NVL(b.specialcode, 'N') not in ('J','K') and " +
                                    	//modify by betty
                                    	"(b.jobno = '100' or b.jobno = '120' or b.jobno='95') and NVL(b.specialcode, 'N') not in ('J','K') and " +
                                    	"a.offtype = '0' and (to_char(a.offsdate,'yyyy-mm') <= '" + myday + "' and " +
                                    	"to_char(a.offedate,'yyyy-mm') >= '" + myday + "') and (a.remark <> '*' or a.remark is null)";
                                }
