...
public class CheckUpdateAl
{
        ...
        public String checktimes(String empn, String mymonth, String mysdate, String myedate, String offyear, String gradeyear)throws Exception{
        	...
        	int kor_crew = 0;
                ...
                aa = "select sern, jobno, station, to_char(indate, 'yyyy-mm-dd') indate from egtcbas " +
                                ...
                                for (int i = 0; i <= offdays; i++)
                                {
                                        ...
                                        else//非日語組組員, 韓語組組員
                                        {
                                                ...
                                                else if (jobno==100 || jobno==120) //FS 100,120
                                                {
                                                    ...
                                                    myResultSet = stmt.executeQuery("select sum(quota) quota from egtquota where yy||'-'||mm=substr('"+theday+"',1,7) and (qitem='TPE FS' or qitem='TPE ZC')");
                                                	while(myResultSet.next()){
                                   			     ...
                                   			     //modify by betty
                                   			     //"( ( EGTCBAS.jobno = "+str1+" or EGTCBAS.jobno = "+str2+") AND " +
                                   			     "( ( EGTCBAS.jobno = "+str1+" or EGTCBAS.jobno = "+str2+" or EGTCBAS.jobno ='95') AND " + 
                                   			     "( EGTCBAS.station = 'TPE' ) AND ( NVL(EGTCBAS.specialcode, 'N') not in ('J','K') ) AND " + 
                                   			     "( to_char(EGTOFFS.offsdate,'yyyy-mm-dd') <= '"+theday+"' ) AND " +  
                                   			     "( to_char(EGTOFFS.offedate,'yyyy-mm-dd') >= '"+theday+"' ) AND " +
                                   			     "( EGTOFFS.offtype = '0' ) and (EGTOFFS.remark <> '*' or EGTOFFS.remark is null))";
                                                ...
                                                {
                                                    //*****add by cs71 2007/03/28 取得當月Quota*****
                                                    //modify in 2007/04/03
                                   			     ...
                                   			     "(  (EGTCBAS.jobno = '95' or EGTCBAS.jobno = '100' or EGTCBAS.jobno = '120') AND " + 
                                   			     "( EGTCBAS.station = 'TPE' ) AND ( NVL(EGTCBAS.specialcode, 'N') not in ('J','K') ) AND " + 
                                   			     "( to_char(EGTOFFS.offsdate,'yyyy-mm-dd') <= '"+theday+"' ) AND " +  
                                   			     "( to_char(EGTOFFS.offedate,'yyyy-mm-dd') >= '"+theday+"' ) AND " +
                                   			     "( EGTOFFS.offtype = '0' ) and (EGTOFFS.remark <> '*' or EGTOFFS.remark is null))";
                                                ...
                                                if (myResultSet != null)
                                                {
                                                	...
                                                	{ 
                                                	        ...
                                                	        {
                                                	                return "Zone chief "+theday+" had over "+zc+" person";
                                                	        }
                                                	}
                                                	myResultSet.close();
                                                }
