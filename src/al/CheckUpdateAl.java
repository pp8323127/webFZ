...
public class CheckUpdateAl
{
		...
		aa = "select nvl(sum(offdays), 0) offcount from egtoffs where sern = "+sern+" and to_char(offsdate,'yyyy-mm-dd') >= '"+myindate+"' and offtype = '0' and remark = 'N'";
			...
			" values (LPAD(egqofno.nextval, 7, '0'), '"+empn+"', "+sern+", '0', to_date('"+myindate+"', 'yyyy-mm-dd'), to_date('"+myedate+"', 'yyyy-mm-dd'), to_date('"+myedate+
		...
		" values (LPAD(egqofno.nextval, 7, '0'), '"+empn+"', "+sern+", '0', to_date('"+mysdate+"', 'yyyy-mm-dd'), to_date('"+cutdate+"', 'yyyy-mm-dd'), to_date('"+cutdate+
