...
while(rs.next())
{
	...
	remark = request.getParameter(siNo+"siNo");
...
<table width="90%"  border="1" align="center" cellpadding="0" cellspacing="0" class="fortable"> 
  ...
  <tr class="tablebody">
 	<td width="62%" class="txtblue" ><div align="left" class="style3">A/C： <%=fleet%><strong>　</strong>(<%=acno%>)<strong>　</strong>　　　CM：<%=purname%></div></td>
