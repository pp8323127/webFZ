...
prbe.setFlag("B");//2012/12/01 更改題庫
...
<%
	    ...
	    {
%>
		<td align="center" colspan ="3"><input name="<%=scoreobj.getSubitem_no()%>" id="<%=scoreobj.getSubitem_no()%>" type="text" value="<%=scoreobj.getScore()%>"  size="3" maxlength="3"></td>		
<%
		}
		else
		{
%>
		...
		<td align="center" ><input name="<%=scoreobj.getSubitem_no()%>" type="radio" value="0" <%=var0%>></td>
<%
		}
%>
