...
<table width="95%"  border="0" align="center" cellpadding="2" cellspacing="0">
  <tr>
    <td width="60%">
      <div align="right"><span class="txttitletop"><%=fyy%> 年 客艙經理任務簡報表現評量 </span></div>
    </td>
...
<%
sb.append(fyy+"年 客艙經理任務簡報表現評量統計\r\n");	
sb.append("#,EMPNO,SERN,NAME,BASE,JUN,FEB,MAR,APR,MAY,JUN,JUL,AUG,SEP,OCT,NOV,DEC,TTL,SCORE\r\n");	
%>

<%
PRBriefEval prbe = new PRBriefEval();
prbe.getPRBriefEvalStat2(fyy,base);
...
<%
sb.append((i+1)+","+obj.getPurempno()+","+obj.getPursern()+","+obj.getPurname()+","+obj.getBase()+","+obj.getMyHT().get("01")+","+obj.getMyHT().get("02")+","+obj.getMyHT().get("03")+","+obj.getMyHT().get("04")+","+obj.getMyHT().get("05")+","+obj.getMyHT().get("06")+","+obj.getMyHT().get("07")+","+obj.getMyHT().get("08")+","+obj.getMyHT().get("09")+","+obj.getMyHT().get("10")+","+obj.getMyHT().get("11")+","+obj.getMyHT().get("12")+","+obj.getChk_times()+","+tempstr+"\r\n");	
%>
<%
	}
}
