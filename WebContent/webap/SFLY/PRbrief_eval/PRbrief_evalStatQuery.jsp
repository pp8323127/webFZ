...
<title>客艙經理任務簡報表現評量 統計報表(1)</title>
...
<body>
<form action="PRbrief_evalStat.jsp" method="post" name="form1" target="mainFrame" class="txtblue" onsubmit="return chkRequest();">
<fieldset style="width:80%; ">
<legend class="txtred">任務簡報表現評量 統計報表(評量明細)</legend>
 <br>
