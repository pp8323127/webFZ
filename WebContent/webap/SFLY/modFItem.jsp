...
sql = "select * from egtstfi where itemno='"+reqItemno+"'" ;
...
<form name="form1" method="post" action="updFItem.jsp" onsubmit="return checkField()">
  <table width="65%"  border="0" align="center"  class="tablebody">
    ...
    <tr>
      <td>
        <div align="center">
          <input type="text" name="itemno" maxlength="2" size="2" value="<%=itemno%>" onkeyup="javascript:this.value=this.value.toUpperCase();">
        </div>
      </td>
      <td>
        <div align="left">
