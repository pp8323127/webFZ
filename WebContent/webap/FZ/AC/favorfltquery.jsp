...
<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
      <td width="5%">&nbsp;</td>
      <td width="90%" class="txtblue"><div align="center"></div>
      </td>
      <td width="5%">
...
%>
  ...
  <tr bgcolor="<%=bcolor%>">
    <td class="tablebody" ><%=rs_emp%></td>
    <td class="tablebody" nowrap><%=cname %></td>
    <td class="tablebody"><%=box %></td>
    <td class="tablebody"><%=occu %></td>
    <td class="tablebody"><%=base %></td>
    <td class="tablebody"><a href="../mail.jsp?to=<%=email%>&cname=<%=ename%>" target="_blank"><img alt="mail to <%=cname%>" border="0" height="15" src="../images/mail.gif" width="15"></a></td>
