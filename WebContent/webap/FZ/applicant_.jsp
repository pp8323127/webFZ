...
<body bgcolor="#FFFFFF" text="#000000">
  ...
  <form name="form1" method="post"  action="sendapp.jsp" >
...
<table width="70%" border="0" cellpadding="0" cellspacing="0">
    ...
    Applicant</b></span><br>
        ...
        <tr>
          ...
          <td width="24%" class="tablehead">Detail</td>
          <td width="23%" class="tablehead">Select All 
            <input name="putAll" type="checkbox" onClick="CheckAll('form1','putAll');CheckAll('form1','putAll2');CheckAll('form1','checkput2')">
          </td>
        </tr>
        <%
		int c = 0;
...
%>
        <tr bgcolor="<%=bcolor%>">
          ...
          <td class="tablebody">
            <div align="center">
              <input type="checkbox" name="checkput" id="checkput"value="<%=fdate%><%=tripno%><%=fltno%>">
          </div></td>
        </tr>
        <%
	}
...
%>
        <tr bgcolor="<%=bcolor%>">
          ...
          <td class="tablebody">
            <div align="center">
              <input type="checkbox" name="checkput2" id="checkput2" value="<%=fdate%><%=tripno%><%=empno%><%=fltno%>">
          </div></td>
        </tr>
        <%
	}
          ...
          <td width="38%">          
            <div align="right">
              ...
              <input type="hidden" name="mymm" value="<%=mymm%>">
                <font face="Arial, Helvetica, sans-serif" size="2"><b><font color="#FF0000">Comments for TPEED</font></b></font></div>
          </td>
          
        <td width="62%"> 
          <div align="left">           <!-- <input type="text" name="comments" size="50" value="N" maxlength="50">	-->
