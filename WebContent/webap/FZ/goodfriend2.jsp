...
<form  method="post" name="form1" action="mail_cs66.jsp" target="_self">
  <table width="92%"  border="1" align="center" cellpadding="0" cellspacing="1" class="fortable">
    <tr>
      <td colspan="13" class="tablehead3"><div align="center">設我為好友者（I am in his friend list） </div></td>
    </tr>
    <tr>
      ...
      <td width="9%" bgcolor="#999999"  class="tablebody style1">Schk</td>
	...
	%>
      <tr>
        <td class="tablebody">
          <div align="center"><a href="crewquery.jsp?tf_ename=&tf_sess1=&tf_sess2=&tf_empno=<%=bf_empno%>" target="_self" ><%=bf_empno%></a>
