...
function openTSAcrew() {
	wTSAcrew = window.open('http://10.16.50.86:8080/apex/f?p=104:8:387183685200953:::::', 'TSAcrew'
	  , config='height=400,width=800,scrollbars=yes,titlebar=no,location=no,resizable=yes')
}
</script>
