...
<table width="90%" border="0" cellpadding="0" cellspacing="0" align="center">
  ...
  <table width="90%"  border="1" cellpadding="1" cellspacing="0" align="center">
    ...
    <tr > 
      ...
      <td class="tablebody"><%=aCrewInfoObj.getCname()+aCrewInfoObj.getSpCode()%> 
        <input type="hidden" name="aCname" value="<%=aCrewInfoObj.getCname()+aCrewInfoObj.getSpCode()%>">
      </td>
      <td class="tablebody"><%=aCrewInfoObj.getGrps()%> 
        <input type="hidden" name="aGrps" value="<%=aCrewInfoObj.getGrps()%>">
      </td>
      <td class="tablebody"><%=rCrewInfoObj.getCname()+rCrewInfoObj.getSpCode()%> 
        <input type="hidden" name="rCname" value="<%=rCrewInfoObj.getCname()+rCrewInfoObj.getSpCode()%>">
      </td>
