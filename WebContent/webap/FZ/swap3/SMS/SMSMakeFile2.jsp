...
if(request.getParameter("classType") != null | !"".equals(request.getParameter("classType"))){
makeFile.makeSomeDay2(fdate,sGetUsr,ct.getTable(),false,request.getParameter("classType"));
}else{
makeFile.makeSomeDay2(fdate,sGetUsr,ct.getTable(),true,"");
}
