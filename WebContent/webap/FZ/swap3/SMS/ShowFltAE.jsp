...
<table width="80%"  border="0" align="center" cellpadding="2" cellspacing="0"  >
  <tr >
    <td class="txtblue" >
      <form name="form1" method="post" action="SMSMakeFileFltno.jsp?fdate=<%=requestFdate%>&db=<%=ct.getTable()%>&delFtlnoList=<%=delFtlnoList%>">
        <div align="center"> 
...
<table width="80%"  border="0" align="center" cellpadding="2" cellspacing="0" >
  ...
  <tr >
    <td class="txtblue" >
      <form name="form3" method="post" action="SMSMakeFileFltno.jsp?fdate=<%=requestFdate%>&db=<%=ct.getTable()%>&delFtlnoList=<%=delFtlnoList%>">
        <div align="center"> 
         <input type="submit" name="Submit" value="Make File" class="btm" >
        </div>
      </form>
