...
<%@page import="fz.*,java.sql.*,ci.db.*,swap3.*,java.text.*"%>
<%
...
if(rSwapSkjAL != null){
	...
	{
		CrewSkjObj skjObj = (CrewSkjObj)rSwapSkjAL.get(i);
		if("AL".equals(skjObj.getDutycode()))	
		{
			rALtimes++; 
		}
...
<table width="90%"  border="1" cellpadding="0" cellspacing="0" align="center">
  ...
  <tr> 
    ...
    <td width="15%" class="txttitle"><b><font face="Arial, Helvetica, sans-serif" size="2">C ±X +AL=</font></b></td>
