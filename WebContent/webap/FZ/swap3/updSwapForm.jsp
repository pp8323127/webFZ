...
申請單成功送出!!<br>
<br>
  <span style="color:blue">1. 此換班申請單遞出時間若於17:00前，換班作業將於當天工作日完成，若於17:00後遞出，則為下一工作日(例假日不算工作日)完成。
  <br>
  2. 因簽派系統(SBS)與班表資訊網為不同系統，換班資料需經由程式轉檔(至少3~4小時後)始能於班表資訊網中查詢換班後新任務。
  <br>
  3. 無論申請單成功與否，派遣部均會傳送資訊於個人全員信箱(請適時保持信箱可用容量)，在未收到通知前，無法遞出第二次申請單。</span>  <br>
  <br>
  <a href="../applyquery.jsp" style="text-decoration:underline "><span style="color:#0000FF">查詢申請單記錄</span></a>
</span><br>
