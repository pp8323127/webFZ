...
String thisY = Integer.toString(calendar.get(Calendar.YEAR)+1);//
...
if( "CM".equals(occu) | "PR".equals(occu) | "Y".equals((String)session.getAttribute("powerUser"))
...
%>
		...
		<img src="img2/doc5.gif" width="16" height="16">&nbsp;<a href="#"  onClick='load("blank.htm","PRAC/PRSel.jsp")'>Cabin Report</a><br><br>

		<img src="img2/doc5.gif" width="16" height="16">&nbsp;<a href="#"  onClick='load("blank.htm","PRAC_new/PRSel.jsp")'>Cabin Report new</a><br><br>
...
if("ZC".equals(occu) |"PU".equals(occu)|"Y".equals((String)session.getAttribute("ZC")) ){	
	if(newName){
%>
