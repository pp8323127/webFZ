...
%>
<form action="crewqualification_list_new.jsp" method= "post" name= "form1" target="mainFrame">
 
  <table width="700" align="center">
    <tr class="detail">
	<td class="title">(New)Fleet :</td>
	<td class="change">
	...
	<td class="title">Qualifications :</td>
		...
		<select name="slt_QUALIFICATION" id="slt_QUALIFICATION">
			...
			<option value="A009"            >China VISA (for EXP) (CHN)</option>
