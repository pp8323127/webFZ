...
String rip = "NotSet";
rip = request.getHeader("HTTP_X_FORWARDED_FOR");
if (rip == null)  rip = request.getRemoteAddr();


//10.152.10: VPN client for SZX
//if(!"192.168".equals(loginIP.substring(0,7)) && !"10.152.10".equals(loginIP.substring(0,9)) ){
if(!"625303".equals(userid) && !"192.168".equals(loginIP.substring(0,7)) && !"10.152.10".equals(loginIP.substring(0,9))
...
// 特殊密碼 for test user authentication right "fz27123141"     cs27 2009/12/31 added
...
//Step3. 判斷單位及授權
	...
	else if (userid.equals("635477") | userid.equals("630574")){			
	...
	*/	 
		...
		&& (funitcd.equals("190A") | funitcd.equals("195B")  | funitcd.equals("193B") | funitcd.equals("193E") 
		  ...
		  | 
		 ( (
		  funitcd.equals("635")   | funitcd.equals("631A") | funitcd.equals("811") | funitcd.equals("837")  
...
*/
	else if(funitcd.equals("141H")|funitcd.equals("1411") |funitcd.equals("140E") |  funitcd.equals("142E") |  funitcd.equals("141G")){ 
	...
	//PA Raw Score Teacher: 624866田玉青,626791牛博文,629648向夢麟,於 MT 中設定群組為 EGPARAW
...
out.println("<script>"); 
  ...
  out.println("//rip = "+rip) ;
  out.println("//loginIP_5= "+ loginIP.substring(0,5) ) ;
</script>) ;
out.println("</script>") ;
%>
</head>
...
<script> 
//uid2= <%=uid2%>  uid1= <%=uid1%>
//location.href="<%=goPage%>" ;           //forward to new page </script>
...
<%=msg%><br><br>
Please <a href="index2.htm" target="_self"> Login </a><br>
</DIV>
