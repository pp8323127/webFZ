...
sql = "SELECT DISTINCT fleet_cd fleet FROM dfdb.dftcrec " + 
      " WHERE ( yy >= To_Char(sysdate-900,'yyyy')  ) " +
      "    AND fleet_cd NOT IN ('XXX','BEF','Y8') 	ORDER BY 1 " ;
...
sql = "select  * from dfdb.dftcrew where empno='"+empno+"' and flag='Y'";
...
if (conn != null) { out.println("conn   is not null , conn OK .<br>"); } else { 
	out.println("Fail1 - conn is null<br>");	}
out.println("</script>") ;
...
<center>
  <span class="txttitletop">新增 Crew Record </span><br>
...
<hr>
Remark說明: <br>
RecType - "M" 月份累計 / "A" 非月份累計<br>
Fleet_cd - "BEF" before CAL / "Y8" YZR 揚子江快運
</body>
</html>