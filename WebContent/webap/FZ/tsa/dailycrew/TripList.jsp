...
try{
	...
	//"DECODE(dps.duty_cd, '0', 'SICK', dps.duty_cd) " + 
	"from roster_v r, duty_prd_seg_v dps " +
	"where r.series_num = dps.series_num and " +
	//"dps.fd_ind='N' and
	" (dps.duty_cd='FLY' or dps.duty_cd='LO' or dps.duty_cd='TVL' or dps.duty_cd='SICK') and r.delete_ind='N' and " +
	"r.series_num=" + tripno +
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><input name="bt" type="button" class="btm" value="<%=butlabel%>" onClick="self.location='TripList.jsp?tripno=<%=tripno%>&flag=<%=chk%>'"></td>
...
%>
  ...
  <tr class="txtblue">
  	<td>
	<%
	if ("0".equals(myResultSet.getString("fltno"))){
		out.print("<span style=color:red>SICK</span>");
	}else{
		out.print(fltno);
	}//if	
...
<table width="90%"  border="1" align="center" cellpadding="0" cellspacing="0" class="tablebody">
  <tr class="tablehead">
    ...
    <td width="16%">SerNo</td>
	<td width="15%">Name</td>
    <td width="12%">Qual</td>
    <td width="10%">Acting</td>
    <td width="16%">SPcode</td>
  </tr>
  <%
  	Count = 0;
  	if(myResultSet != null){
