...
String  errMsg = "";
RetrieveCheckRCData rd = new RetrieveCheckRCData(fleet,rank);
ArrayList al = new ArrayList();
try {
		rd.SelectData();
		al = rd.getDataAL();
		if (al != null) {
			session.setAttribute("trnRecordRC",al);
		}
	status = true;
...
<table width="70%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" align="center">
  <tr class="tablehead4">
    ...
    <td width="16%">
      <div align="center">CheckType</div>
    </td>
  </tr>
  <%
int rowCount = 1;
...
%>
  <tr bgcolor="<%=bgColor%>">
    ...
    <td>
      <div align="center"><%=ck.getChktype()%></div>
    </td>
  </tr>
  <%
rowCount ++;
