...
<table width="90%"  border="0" cellpadding="1" cellspacing="1" align="center">
  ...
  <tr >
    <td> 
	<!-- <span class="fonte_dblue2">Fleet:<span class="txtred"><strong><%//=fleet%></strong></span> Rank:<span class="txtred"><strong><%//=rank%></strong></span> </span> -->
	<!-- 總人數：<span class="txtred"><%//=total%> </span>&nbsp; -->
	<!-- 季節：<span class="fonte_pink">-->	
	<% //if("on".equals(peak)){out.print("&nbsp;旺季&nbsp;&nbsp;");}else{out.print("&nbsp;淡季&nbsp;&nbsp;");} %>
	<!-- </span> -->
    <!-- 預估需受訓人數：<span class="txtred"><%//=expect%></span>&nbsp;&nbsp;目前選擇人數：<span  id="showTotal">0</span> -->
	</td>
  </tr>
  <tr >
...
<table width="90%"  border="1" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC" align="center">
  <tr class="tablehead4">
    <!--<td width="10%">All<input type="checkbox" name="noSel" onClick="CheckAll('form1','noSel');calc()" id="noSel"></td> -->
    ...
    <td><div align="center"><% if("PC".equals(checkType)){ out.print("Last<BR>CheckType"); }else{ out.print("Last<BR>Subject"); }  %> </div>
    <td><div align="center">系統預排 或<BR><strong><font color="#0000FF">承辦人輸入</font></strong></div></td>
    <td><div align="center">Current<BR>Subject</div></td></td>
  </tr>
  <%
int rowCount = 1;
...
%>
  <tr bgcolor="<%=bgColor%>">
    <!-- <td><div align="right"><input type="checkbox" value="<%=i%>" name="sel" onClick="calc()"><%=rowCount%></div></td> -->
    <td><div align="center"><%=ck.getFleet() %></div></td>
    <td><div align="center"><%=ck.getRank() %></div></td>
    <td><div align="center"><%=ck.getEmpno()%></div></td>
    ...
    <td><div align="center"><%=ck.getDate() %></div></td>
    <td><div align="center"> <%
	  	if("PC".equals(checkType)){  
	...
	try {	
		...
		sql = "select ckadjdt from " +
					...
					"and ckadjdt > to_date('"+ck.getDate()+"','yyyy-mm-dd') " +
	...
	%>	
	<a href="#" onClick="subwinXY('pc_update_form.jsp?curremp=<%=ck.getEmpno()%>&currname=<%=ck.getCname()%>&chktype=<%=checkType%>', '', '400', '300')"> 
