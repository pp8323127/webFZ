...
String goPage  = "";
String aEmpno = (String) request.getParameter("aEmpno"); //(String) session.getAttribute("userid");
String rEmpno = (String) request.getParameter("rEmpno"); //(String) session.getAttribute("rEmpno");
String empno = (String)request.getParameter("rEmpno");
...
else if(null == request.getParameter("rEmpno") | "".equals(request.getParameter("rEmpno")) )
{
%>
<p style="background-color:#99FFFF;color:#FF0000;
		font-family:Verdana;
...
<%
		  if(!"ADO".equals(obj.getDutycode()) && !"B1".equals(obj.getDutycode()) && !"EE".equals(obj.getDutycode()) && !"MT".equals(obj.getDutycode()) && !"CT".equals(obj.getDutycode()) && !"FT".equals(obj.getDutycode()) && !"B2".equals(obj.getDutycode()) && !"GS".equals(obj.getDutycode()) && !"BL".equals(obj.getDutycode()) && ((!"0".equals(obj.getTripno()) && !"AL".equals(obj.getDutycode()) && !"XL".equals(obj.getDutycode()) && !"LVE".equals(obj.getDutycode())) || ("0".equals(obj.getTripno()) && ("AL".equals(obj.getDutycode()) | "XL".equals(obj.getDutycode()) | "LVE".equals(obj.getDutycode()))) ) )
		  {		 
%>
...
%>				
        ...
        <td class="tablebody" align="center">&nbsp;
 <%
		 if(!"ADO".equals(obj.getDutycode()) && !"B1".equals(obj.getDutycode()) && !"EE".equals(obj.getDutycode())
...
<table width="70%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
	  <td><p class="txtblue"><br>
		...
		<span class="txtxred">註：<strong>顯示之休時僅供參考，正確休時請以派遣部回覆為準。</strong></span><br>
		</p>          
	  </td>
  </tr>
</table>
