...
function viewCrewInfo(empno){
		...
		document.form1.action="AC/crewInfo.jsp";				
		document.form1.submit();
	}
...
<div align="center"><span class="txttitletop">Friend List(好友名單列表)</span>&nbsp;&nbsp;&nbsp;&nbsp;<a href="goodfriend2.jsp" target="_blank" class="bu" >&nbsp;看哪些人設我為好友&nbsp;</a></div>
<div align="center"><br>
...
<form  method="post" name="form1" >
  <table width="92%"  border="1" align="center" cellpadding="0" cellspacing="1" class="fortable">
    <tr>
      <td height="23" colspan="13" class="tablehead3"><div align="center">我的好友（My Friend ） </div></td>
    </tr>
    <tr>
      ...
      <td width="11%" bgcolor="#999999"  class="tablebody style1">Schedule</td>
	...
	%>
      <tr>
        ...
        <td class="tablebody"><div align="center"><a href="showsche2.jsp?empno=<%=bf_empno %>&syear=<%=syear %>&smonth=<%=smonth%>" target="_blank"><img src="images/search.gif" border="0" alt="show schedule"></a></div></td>
    ...
    <tr>
      <td colspan="13"  class="tablebody"><div align="center">&nbsp;&nbsp;
