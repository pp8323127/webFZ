...
<tr>
  <td width="70%" valign="top">	
   <table width="100%"  border="0" cellspacing="0" cellpadding="0">
	<tr><td height="1" valign="bottom" colspan="4"><hr></td></tr>
   	<tr>
	  <td width="98%" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;NAME&nbsp;&nbsp;OF&nbsp;&nbsp;CREW</td>
	  <td width="2%" align = "right">:</td>
	</tr>
	<tr><td height="1" valign="top" colspan="4"><hr></td></tr>
    <tr><td colspan="4">
	    <table width="100%"  border="0" cellspacing="0" cellpadding="0">
		<%
			for(int i=0; i<objAL.size(); i++){
				...
				// 顯示本國籍中文姓名 CS40 2012-6-28(不含8個日本人)
				cname = "";		
			    if (  ("6".equals(obj.getEmpno().substring(0,1)) | "5".equals(obj.getEmpno().substring(0,1))) & 
				      (! "630484".equals(obj.getEmpno()) ) & (! "630488".equals(obj.getEmpno()) ) & (! "630501".equals(obj.getEmpno()) ) &
				      (! "631768".equals(obj.getEmpno()) ) & (! "631770".equals(obj.getEmpno()) ) & (! "627906".equals(obj.getEmpno()) ) &
				      (! "626460".equals(obj.getEmpno()) ) & (! "631654".equals(obj.getEmpno()) ) 
				   || ("48".equals(obj.getEmpno().substring(0,2)) )				   
				   ){ 		    
		            ...
		            try {	
						...
						conn.setAutoCommit(false);	
			            stmt = conn.createStatement();		 
			            sql = "select cname from hrdb.hrvegemploy where employid='"+obj.getEmpno()+"'";							
						rs = stmt.executeQuery(sql); 	
						if(rs != null){
						   while (rs.next()){ cname = rs.getString("cname") ; }//while			   
