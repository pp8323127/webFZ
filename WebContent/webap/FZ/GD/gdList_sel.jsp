...
WebGd we = new WebGd();
// Betty add start
we.getWebEgData(arln,yyyy+"/"+mm+"/"+dd,fltno,dpt,delay,dailycrew);
// Betty add end
...
<%
if(("CAN,PVG,PEK".indexOf(dpt_short) >= 0 | "CAN,PVG,PEK".indexOf(arv_short) >= 0) && ("TPE".equals(dpt_short) | "KHH".equals(dpt_short)))
{
%>
		<tr>
...
<%
if(("CAN,PVG,PEK".indexOf(dpt_short) >= 0 | "CAN,PVG,PEK".indexOf(arv_short) >= 0) && ("TPE".equals(arv_short) | "KHH".equals(arv_short)))
{
%>
		<tr>
