...
ccr.getCpsCssRecord(caseno,userid);
...
if(objAL.size()>0)
{
	...
	String tempaction_taken = dispobj.getAction_taken();
	...
	if(!"".equals(tempaction_taken) && tempaction_taken != null)
	{
		tempaction_taken = tempaction_taken.replaceAll("\r\n","<br>");
	}
...
%>
	 ...
	 <tr class="txtblue">
		<td align="center" class="tablehead">處理<br>狀況</td>
		<td align="left" colspan="6"><%=tempaction_taken%></td>
     </tr>
<%
}
else
