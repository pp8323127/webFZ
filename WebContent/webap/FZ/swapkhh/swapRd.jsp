...
ArrayList formtypeAL  = new ArrayList();
String bcolor=null;
...
String sql =" select * from ( select formno,acname,aempno,rcname,checkuser,"
	+"rempno,chg_all,nvl(ed_check,'&nbsp;') ed_check,nvl(comments,'&nbsp;') comments,"
	+"to_char(newdate,'yyyy/mm/dd hh24:mi') newdate,"
	+"nvl(to_char(checkdate,'yyyy/mm/dd hh24:mi'),'&nbsp;') checkdate, 'A' formtype from fztformf "
	+"where station='KHH' and (aempno = '"+ QueryID+"' or rempno='"+ QueryID+"') "
	+"and  formno ";
...
sql = sql + "select formno,acname,aempno,rcname,checkuser,"
	+"rempno,chg_all,nvl(ed_check,'&nbsp;') ed_check,nvl(comments,'&nbsp;') comments,"
	+"to_char(newdate,'yyyy/mm/dd hh24:mi') newdate,"
	+"nvl(to_char(checkdate,'yyyy/mm/dd hh24:mi'),'&nbsp;') checkdate, 'B' formtype from fztbformf "
...
while(rs.next())
{
		...
		formtypeAL.add(rs.getString("formtype"));
}
rs.close();
sql="";
...
table td.noborder {
border:0pt;font-size:10pt; text-align:center}
.selected  {	
...
<body onLoad="stripe('t1')">
  ...
  電子換班單記錄  </div>
    <table width="95%" border="0" cellspacing="0" cellpadding="0" id="t1">
      <tr class="selected"> 
        <td width="9%" class="selected">Form No</td>
...
%>
      <tr > 
	  <td><%=formtypeAL.get(i)%><%=formnoAL.get(i)%></td>
	...
	<%
	if("A".equals(((String)formtypeAL.get(i)).trim()))	
	{
	%>
			<td> 
	...
	%>
			<td> 
			  <div align="center"><a href="../credit/swapkhh/showBForm.jsp?formno=<%=formnoAL.get(i)%>" target="_blank"> 
				<img src="../images/red.gif" width="15" height="15" border="0" alt="Detail"></a></div>
			</td>
	<%
	}
  ...
  <div align="center">
    <p>	
	  ...
	  <tr>
		  ...
		  <td class="noborder"><div align="left"><span style="color:#FF0000 ">相同申請單，請勿重複遞單</span></div></td>
	  </tr>
	  <tr>
		  <td class="noborder"><span style="color:#FF0000 ">* </span></td>
		  <td class="noborder"><div align="left"><span style="color:#FF0000 ">A 開頭單號為三次換班申請單</span></div></td>
	  </tr>
	  <tr>
		  <td class="noborder"><span style="color:#FF0000 ">&nbsp;</span></td>
		  <td class="noborder"><div align="left"><span style="color:#FF0000 ">B 開頭單號為積點換班申請單</span></div></td>
	  </tr>
	  </table>
