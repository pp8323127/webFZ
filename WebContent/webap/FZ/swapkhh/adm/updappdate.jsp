...
//判斷是否已有值
int count = 0;
String sqlquery ="select setdate from fztsetdf where station='KHH' and to_char(setdate,'YYYY/MM/DDhh24mi') ='"+sdateyyyy+"/"+sdatemm+"/"+sdatedd+sdatehh+sdatemi+"'";
...
{
String sql = "insert into fztsetdf(setdate,station,setedate) values(to_date('"+sdateyyyy+"/"+sdatemm+"/"+sdatedd+sdatehh+sdatemi+"','YYYY/MM/DDhh24mi'),'KHH',to_date('"+edateyyyy+"/"+edatemm+"/"+edatedd+edatehh+edatemi+"','YYYY/MM/DDhh24mi'))";
