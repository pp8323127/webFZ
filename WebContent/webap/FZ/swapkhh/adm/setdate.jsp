...
String tempbgcolor = "";
String sql = "select to_char(setdate,'YYYY/MM/DD hh24:mi') setdate, to_char(setedate,'YYYY/MM/DD hh24:mi') setedate from fztsetdf where station='KHH' order by setdate";
