...
String sql = "SELECT rownum, a.staff_num EMPNO, a.sen_num BOX, " + 
                  ...
                  "b.rank_cd OCCU, " +
				  "c.base BASE, " +
				  "d.EMAIL, d.MPHONE, d.HPHONE, d.ICQ, a.remarks " +
...
if(myResultSet != null){
	while (myResultSet.next()){
		...
		pamonth =   myResultSet.getString("remarks");	
	}
}
%>
...
<form name="form1" method="post" action="updcrewinfo.jsp">
  <table width="79%" border="1" align="center" cellpadding="1" cellspacing="0" class="tableStyl1">
	...
	<tr>
	   <td class="sel3"> <div align="center">ETS受訓月份</div></td>
       <td class="blue"><div align="center"><%=pamonth%> </div></td>
	   <td colspan="2"></td>       	   	   
    </tr>
