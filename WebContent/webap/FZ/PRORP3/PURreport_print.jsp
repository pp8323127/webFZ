...
<%@page import="fz.pr.orp3.*,java.sql.*,ci.db.ConnDB"%>
<%
...
//登機準時資訊
fz.pr.orp3.BordingOnTime borot = new fz.pr.orp3.BordingOnTime(fltd,fltno,sect,psrEmpno);
try {
	borot.SelectData();
...
<div align="center">
  ...
  <span class="style12">CM'S TRIP REPORT
  </span></div>
...
%>
	...
	<tr>
     <td colspan="12" class="style21">Shift Record : <%=shift %></td>
	</tr>
   </table>
  </td>
 </tr>
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="151" colspan="4" valign="top"><strong>III.Flight Irregularity : </strong>
		...
		<%
		rCount = 0;
		sql = "select a.itemdsc desc1, b.itemdsc desc2, nvl(b.comments,'&nbsp;') comm, nvl(b.reply,'&nbsp;') reply,b.clb,b.mcr,b.rca,b.emg, b.yearsern "+
