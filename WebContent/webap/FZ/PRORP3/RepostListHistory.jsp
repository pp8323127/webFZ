...
//取得考績年度
String GdYear = fz.pr.orp3.GdYear.getGdYear(yy+"/"+mm);
...
%>
<div align="center">
  <span class="txttitletop">Pursers' Report List --<%=mm+"/"+yy%> </span> 
...
<%
	 ...
	 response.sendRedirect("../showmessage.jsp?messagestring="+URLEncoder.encode("No DATA!!"));
}
%>
</div>
</body>
