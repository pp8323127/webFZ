...
<%@ page import="java.sql.*,java.net.URLEncoder,fz.pr.orp3.*,ci.db.ConnDB" %>
<%
...
String goPage = "edFltIrr.jsp?fdate="+fdate+"&fltno="+fltno+"&dpt="+dpt+"&arv="+arv+"&purserEmpno="+purserEmpno+"&acno="+acno+"&GdYear="+GdYear+"&pur="+purserEmpno;
