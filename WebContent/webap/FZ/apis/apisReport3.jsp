...
else if("NKG,XMN,CTU,CKG,PEK,PVG,SHA,CAN,SZX,HGH,XIY,KMG,CSX,NGB,CGO,DLC,SHE,TAO,FOC,WUH,WNZ,YNZ,KHN,SYX,HAK,WUX".indexOf(obj.getDest()) >= 0 | "NKG,XMN,CTU,CKG,PEK,PVG,SHA,CAN,SZX,HGH,XIY,KMG,CSX,NGB,CGO,DLC,SHE,TAO,FOC,WUH,WNZ,YNZ,KHN,SYX,HAK,WUX".indexOf(obj.getDepart()) >= 0)
{
%>
...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="81%" bgcolor="#C7EDFA"><span class="txtxred" align="right">NKG,XMN,CTU,CKG,PEK,PVG,SHA,CAN,SZX,HGH,XIY,KMG,CSX,NGB,CGO,DLC,SHE,TAO,FOC,WUH,WNZ,YNZ,KHN,SYX,HAK,WUX</span></td>
  </tr>    
    <tr>
