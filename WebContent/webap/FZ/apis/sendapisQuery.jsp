...
<form method="post" name="form1" target="mainFrame" class="txtblue" action="presendapisList.jsp" onsubmit = "return chk();" >
  ...
  Flt No. 
  <input name="fltno" id="fltno" type="text" size="5" maxlength="5" onkeyup="javascript:this.value=this.value.toUpperCase();"> 
...
&nbsp;&nbsp;<a href="saveFile.jsp?filename=Web_APISManual_Send_Guide.doc">手動發送說明</a>
&nbsp;&nbsp;<a href="saveFile.jsp?filename=APIS_Telex_Query_Guide.doc">發報查詢說明</a>
</form>
</body>
</html>
