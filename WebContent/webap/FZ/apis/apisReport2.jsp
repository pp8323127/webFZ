...
document.write("        <p align='center'><font face='Arial, Helvetica, sans-serif' size='3'><b><strong>APISII Data Retrieving, Please wait.....</strong></font></td>");
document.write("    </tr>");
document.write("    <tr> ");
document.write("      <td align='center' width='505' nowrap> ");
...
<%	if("ANC,ATL,BNA,BOS,CVG,DEN,DFW,GUM,HNL,HOU,JFK,LAS,LAX,MIA,NYC,ORD,ORL,PDX,SEA,SFO,TPA,YVR,YTO,YYZ,YMX".indexOf(obj.getDest()) >= 0 | "ANC,ATL,BNA,BOS,CVG,DEN,DFW,GUM,HNL,HOU,JFK,LAS,LAX,MIA,NYC,ORD,ORL,PDX,SEA,SFO,TPA,YVR,YTO,YYZ,YMX".indexOf(obj.getDepart()) >= 0 )
{
%> 
...
<table width="95%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="6%" rowspan="4" valign="top"><span class="txtxred style1" align="right">備註 : </span></td>
