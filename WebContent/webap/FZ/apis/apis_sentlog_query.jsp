...
<body onLoad="load();">
<form method="post" name="form1" target="mainFrame" class="txtblue" action="apis_sentlog_result.jsp" onsubmit = "return chk();" >
  <span style="background-color: rgb(62,19,93); color: rgb(255,255,255)">APIS 
  SENT LOG </span>&nbsp;&nbsp;Date(Scheduled local) 
...
<input name="fltno" id="fltno" type="text" size="5" maxlength="5">
  &nbsp;&nbsp;Dpt
<input name="dpt" id="dpt" type="text" size="3" maxlength="3"  onkeyup="javascript:this.value=this.value.toUpperCase();">
