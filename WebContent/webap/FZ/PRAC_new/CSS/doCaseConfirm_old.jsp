...
<%@ page import="java.sql.*,java.util.*,ci.db.*,tool.ReplaceAll, eg.css.*" %>
<%
...
<table width="90%"  border="1" align="center" cellpadding="1" cellspacing="1" class="fortable"> 
	<tr class="txtblue">
	  	<td width="5%" class="tablehead3 txtblue"><div align="center">座<br>艙<br>長<br>客<br>艙<br>管<br>理<br>觀<br>察</div>
		</td>
<%
	String tempmemo1 ="";
	String tempmemo2 ="";
