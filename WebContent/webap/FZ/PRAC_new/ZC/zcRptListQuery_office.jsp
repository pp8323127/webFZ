...
if("O".equals(request.getParameter("auth")) || "640073".equals(sGetUsr) || "638716".equals(sGetUsr)){
	actionPage="zcRepostListView.jsp";
}
else{
	actionPage="zcRepostList.jsp";
}
%>
...
function goPage(){
	...
	if( yy == thisyear){
		if( (thismonth -mm )>=2){
			document.form1.action="zcRepostListHistory.jsp";
			alert("1顯示歷史紀錄");
			return true;
		}else{
...
<form name="form1" action="zcRepostListHistory.jsp" method="post" target="mainFrame">
