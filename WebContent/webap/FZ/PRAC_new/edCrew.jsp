...
fzac.CrewInfoObj mpObj = new fzac.CrewInfoObj();;//組長
...
else
{
	...
	if(occu.equals("ZC") | occu.equals("PU")){
		%>
		<div style="text-align:center; background-color: #FFFF66; font-size: 16px; color: #FF0000;"><strong>**Training MC 填寫Cabin Report.下方組員名單請先刪除自己的工號,以免重複**</strong></div>
		<%
	}
%>
...
if(occu.equals("ZC") | occu.equals("PU")){
		%>
		<div style="text-align:center; background-color: #FFFF66; font-size: 16px; color: #FF0000;"><strong>**Training MC 填寫Cabin Report.上方組員名單先刪除自己的工號,以免重複**</strong></div>
		<%
	}
%>
