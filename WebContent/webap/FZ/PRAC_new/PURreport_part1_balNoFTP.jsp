  ...
  <table width="100%" height="428"  border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="151" colspan="4" valign="top"><strong>III.Flight Irregularity : </strong>
		...
		<%
		rCount = 0;
		sql = "select a.itemdsc desc1, b.itemdsc desc2, nvl(b.comments,'&nbsp;') comm " +
		"from egtcmpi a, egtcmdt b " +
		"where a.itemno=b.itemno and b.fltd=to_date('"+fltd+"','yyyy/mm/dd') and b.fltno='"+fltno+"' and b.sect='"+sect+"' and b.flag='1'";
		rs	= stmt.executeQuery(sql);
		if(rs != null){
			while(rs.next()){
		%>
          <tr>
            ...
            <td width="65%"><span class="style21"><%=rs.getString("comm")%></span></td>
          </tr>
		<%
				rCount++;
			}
...
<br>
  <table width="100%"  border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td><span class="style16">&nbsp;<!--表單編號 : F-EF002E--></span></td>
      <td><div align="right" class="style13">PrintDate : <%=theday%> </div></td>
    </tr>
  </table>
</body>
</html>
