...
<table width="72%"  border="0" align="center" cellpadding="2" cellspacing="0" class="fortable">
  <tr class="tablehead3">
    <td width="13%">Fdate</td>
    <td width="7%">Fltno</td>
    <td width="10%">Sect</td>
    <td width="12%">Status</td>
    <td width="10%">PR Rpt</td>
    <td width="10%">ZC Rpt</td>
...
%>
		 ...
		 <img src="../images/ed1.gif" width="16" height="16" style="margin-right:1em;border:0pt; " alt="PSFLY Request">
		 </a>
<%
		}
		else
...
%>
		 ...
		 <img src="../images/ed1.gif" width="16" height="16" style="margin-right:1em;border:0pt; " alt="ProjInvestigation Request">
		 </a>
<%
		}
		else
