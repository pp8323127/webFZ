...
String[] dutySelItem = {"X","Z1","1L","1R","Z2","2L","2R","UDZ","UDR","UDL","UDA","Z3","3L","3R","3LA","3RA","4LA","4RA","4L","4R","5L","5R","ZC","OD","PA","ACM","DFA"};
...
%>
		&nbsp;&nbsp;&nbsp;
		<input type="button" name="viewzc" value="ZC Report" class="bu" Onclick="javascript:window.open ('ZC/ZCreport_print.jsp?idx=0&fdate=<%=fdate%>&fltno=<%=fltno%>&port=<%=dpt%><%=arv%>&purempn=<%=psrempn%>','zcreport','height=600, width=800, toolbar=no, menubar=no, scrollbars=yes, resizable=yes');" >
<%
