...
function checkCharacter(){
	...
	var item1 = document.form2.item1.value; 
	var message = document.form2.comm.value;
	var len = document.form2.comm.value.length;
	var cnt = 0;
	if(item1 == "硬體缺失")
	{
		if (document.form2.elements["clb"][0].checked)
		{
			cnt++;
		}
		if (document.form2.elements["clb"][1].checked)
		{
			cnt++;
		}
		if(cnt<=0)
...
<tr>
  ...
  <td width="98%"><span class="txtblue">組員登機準時：
	...
	<br>
<div style="display:none "><span class="txtblue"> 
組員登機時間：
...
<input  type="text" name="bdtm" value="0001" size="4" maxlength="4" id="bdtm" style="background-color:#FFFFCC " >
