...
String goPage = "edGdType.jsp?sern="+sern+"&fltno="+fltno+"&fdate="+fdate+"&s="+sect+"&g="+GdYear+"&empno="+empno+"&cname="+URLEncoder.encode(cname)+"&ename="+ename;
if(updSuccess){
...
goPage = "edGdType2.jsp?&fdate="+fdate+"&yearSern="+yearSern+"&cname="+URLEncoder.encode(cname)+"&ename="+ename;
%>
<%=msg%><br>
