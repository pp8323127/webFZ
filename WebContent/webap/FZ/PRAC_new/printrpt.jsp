...
<div align="center">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    ...
    <tr>
      <td><strong>I.</strong>CM : <%=purObj.getCname()%></td>
...
%>
      ...
      <td height="26"><div align="center" class="style4"><%=cobj.getSern()%></div></td>
      <td height="26"><div align="center" class="style4"><%=cobj.getCname()%></div></td>
      <td height="26"><div align="center" class="style4"><%=cobj.getGrp()%></div></td>
	  <td height="26"><div align="center" class="style4"><%=cobj.getOccu()%></div></td>
