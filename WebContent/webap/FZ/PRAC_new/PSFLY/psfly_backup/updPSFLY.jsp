...
*/	
	...
	try
	{
		...
		sql = "insert into egtprsf (fltdt,fltno,sect,empno,fleet,acno,topic_no,itemno,num_satisfy,duty_satisfy,num_needtoimprove,duty_needtoimprove,factor_no,factor_sub_no,newdate,desc_needtoimprove) values (to_date(?,'yyyy/mm/dd'),?,?,?,?,?,?,?,?,?,?,?,?,?,sysdate,?) ";
