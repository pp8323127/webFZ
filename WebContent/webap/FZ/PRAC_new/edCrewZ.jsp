...
//GetFltInfo ft = new GetFltInfo(fdate, fltno,true);
//FlightCrewList fcl = new FlightCrewList(ft,dpt+arv);
GetFltInfo ft = new GetFltInfo(fdate, fltno, dpt+arv);
  ...
  <table width="579" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
      <td colspan="3" valign="middle">
        ...
        <span class="txtblue">Cabin's Report&nbsp;       <strong>&nbsp;</strong></span><span class="txtxred"><strong> Step1.Select Crew List(Add or Delete Crew List) </strong></span></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="3" valign="middle" class="txtblue">Cabin:<span class="txtred"><%=purObj.getCname()%>&nbsp;<%=purObj.getSern()%>&nbsp;<%=purObj.getEmpno()%></span>&nbsp;CA&nbsp;:<span class="txtred"><%=caObj.getEmpno()+"&nbsp;"+caObj.getCname()+"&nbsp;"+caObj.getEname()%></span></td>
    </tr>
</table>
