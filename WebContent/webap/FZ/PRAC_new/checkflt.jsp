...
if ( cflt.isHasFltData() ) {//有flight資料
	...
	goPage = "edCrew.jsp?fdate="+fdate+"&fltno="+fltno+"&dpt="+dpt+"&arv="+arv+"&pxac="+pxac+"&book_total="
		...
		+"&pursern="+pursern+"&purserEmpno="+purserEmpno+"&pgroups="+pgroups+"&stdDt="+stdDt;
	}
}else{//無flight 資料
	goPage = "edCrew.jsp?fdate="+fdate+"&fltno="+fltno+"&dpt="+dpt+"&arv="+arv+"&pxac="+pxac+"&book_total="
		+book_total+"&acno="+acno+"&f="+f+"&c="+c+"&y="+y+"&GdYear="+GdYear+"&purname="+URLEncoder.encode(purname)
...
if(!"Y".equals(isPowerUser) &&
 ...
 && !sGetUsr.equals("629019") && !sGetUsr.equals("625384") && !sGetUsr.equals("630166") && !sGetUsr.equals("628997") && !pbuser.equals("Y")){
