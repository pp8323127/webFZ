...
<html>
<head>
<title>Schedule Query for user lock his schedule</title>
...
function getdate(){	//設定選單預設值
	...
	if (m < 10)	{		//若月份<10，則前面加一個0
		form1.smonth.value= "0"+ m;
	}
	else {
		form1.smonth.value=m;
	}
...
sel_m = parseInt(form1.smonth.value);
 ...
 m = nowdate.getMonth() + 1;
	if (sel_y <= y && sel_m < m){ 
		...
		if (form1.fform.value == "L")
		{
			form1.action = "showsche2.jsp";
		}
		else
		{
			form1.action = "showsche.jsp";
		}
		return true;
...
<form name="form1" method="post"  target="mainFrame" onSubmit="return checkm()">
  ...
  <font color="#000099"><b><font face="Arial, Helvetica, sans-serif" size="2">&nbsp;&nbsp;</font></b></font>  <input type="submit" name="Submit" value="Query" class="btm">
