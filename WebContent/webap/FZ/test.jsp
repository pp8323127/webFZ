...
if(pc.isCheckable() && !pc.isPublished()){	//一個月內的資料，需檢查公佈日期 && 尚未公佈

%>
<p align="center" >
	<span class="txtxred"><u><%=year+"/"+month%> 飛加尚未公佈</u></span>
</p>
<%
} else { //寄送飛加流程 start
...
out.println("</script>");	
	...
	<p align="center" ><a href="flyPayQuery.htm" target="topFrame" ><span class="txtxred"><u>寄送其他月份</u></span></a> </p>
	
	<%
	
	}else if(!sFlyPay.isHasData()){	//尚無飛加資料
	%>
	
	<p align="center" >
		<a href="flyPayQuery.htm" target="topFrame" ><span class="txtxred"><u>尚無飛加資料，請重新選取月份寄送</u></span></a> 
	</p>
	...
	%>
	<p align="center" >
		<a href="flyPayQuery.htm" target="topFrame" ><span class="txtxred"><u>寄送失敗，請重新選取月份寄送</u></span></a> 
	</p>
	<%
	}
