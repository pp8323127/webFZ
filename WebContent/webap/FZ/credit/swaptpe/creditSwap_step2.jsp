...
String asno = (String) request.getParameter("sno");
%>
...
<span style="color:red;text-align:left;font-family:Verdana;font-size:10pt;background-color:#CCFFFF;padding:2pt;">請輸入申請月份與被換者之員工號</span>
<form name="form1" action="creditSwap_step3.jsp" method="post" onsubmit="return checkBlank('form1','rEmpno','Please insert the EmployID of replacer.\n請輸入被換者員工號!!')">
  <p>
    <select name="year">
	  <%
...
for(int i=Integer.parseInt(dateFmY.format(curDate));i<=Integer.parseInt(dateFmY.format(curDate))+1;i++){
  ...
  <p>      
    <input type="submit" class="e4"  value="Next">
