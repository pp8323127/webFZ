...
<p style="background-color:#99FFFF;color:#FF0000;
		font-family:Verdana;
		font-size:10pt;padding:5pt;
		text-align:center">被換者(<%=empno%>)員工號無效!!</p>
...
<div class="errStyle1" >
<br>
被換者： <%=rEmpno%> 非有效的員工號,請<a href="javascript:history.back(-2)" style="text-decoration:underline ">重新輸入</a>!!
<br>
</div>
...
<div class="errStyle1">
<br>
申請者： <%=aEmpno%> 於 <%=year+"/"+month %>  無班表,請<a href="javascript:history.back(-2)" style="text-decoration:underline ">重新輸入</a>!!
<br>
</div>
<%
...
<div  class="errStyle1">
<br>
被換者： <%=rEmpno%> 於 <%=year+"/"+month %>  無班表,請<a href="javascript:history.back(-2)" style="text-decoration:underline ">重新輸入</a>!!
<br>
</div>
<%
}else{
...
<table width="70%" border="0" cellpadding="0" cellspacing="0">
    ...
    Applicant</b></span><br>
        ...
        <tr>
          ...
          <td width="15%" class="tablehead">Fltno</td>
          <td width="15%" class="tablehead">CR</td>
          <td width="10%" class="tablehead">SpCode</td>
          <td width="14%" class="tablehead">Detail</td>
          <td width="18%" class="tablehead">Select </td>
...
%>
    ...
    <span class="txtblue"><b>Substitute</b></span><br>
              ...
              <table width="65%" border="0" cellspacing="0" cellpadding="0">
                <tr>
          <td width="29%" class="tablehead">FltDate</td>
...
%>
  ...
  <p align="center"> 
    <input type="Submit" name="Submit" id="submit" value="送出任務互換資訊" class="bt">
