...
{	
	...
	{
		var count = 0;
		for (var i=0; i<eval(document.form1.length); i++) 
		{
...
<div width="80%" align="center">
    <font face="Comic Sans MS" color="#003399">使用三次換班權利</font>
</div>
<div align="center">
	...
	<table width="80%" border="0" cellpadding="0" cellspacing="0" align= "center">
	  <tr align="center">
		<td>
	      <div align="center">
	        <input name="btn2" type="button" value="申請" onClick="conf('form2')" >			
        </div></td>
	  </tr>
	</table>
<hr>
...
{
%>
	        <input name="btn" type="button" value="申請" onClick="conf('form1')" >			
<%
}
else
{
%>
	       <input name="btn" type="button" value="申請" disabled>			
<%
}	
%>
        </div></td>
