...
{  
	...
	if(offtypeid == "1")
	{
		...
		if(parseInt(iDays) > 186)/*201407 mod*/
		{
			alert("WL 必須於結婚當日起六個月內實施完畢 !!");
			document.getElementById("Submit").disabled=0;
			return false;
		}
...
<br>
  ...
  <legend class="txttitletop">請假申請單 Leave off-sheet</legend>
  <br>
...
%>
  ...
  <table width="80%" border="0" cellpadding="0" cellspacing="1">
	...
	<tr valign="bottom" class="txtblue"> 
		...
		<td width="80%" align = "left"><input maxlength="10" type="text" name="fltno" id="fltno" class="text" size="10" onKeyUp="javascript:this.value=this.value.toUpperCase();"><span class="txtxred">EX:0001Z</span></td>
	</tr>
    </table>
	<br>
    </fieldset>
 ...
 <table width="80%" border="0" cellpadding="0" cellspacing="1">
	...
	<tr class="txtblue">
	 <td>&nbsp;</td><td>結婚當日(發生日)起六個月內實施完畢</td>
	</tr>
	<tr class="txtblue">
	...
	<tr class="txtblue">
		<td>&nbsp;</td><td><span class="txtxred">2012/03/25</span> 始開放申請</td>
	</tr>
 </table>
</div>
</body>
