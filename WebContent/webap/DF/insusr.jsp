...
<%
   ...
   String u1 = "insert into DFTCUSR (";
   String u2 = "userid, password, username";
   String u3 = ") values(";
   String u4 = "'"+userid+"', '"+password+"', '"+username+"')";
   
   if (userid.trim().equals("") || password.trim().equals(""))
   {
%>
        <h4>column:userid, password</h4>
...
<%
 ...
 try{
   ...
   {*/
%>
      <h1>Successful Addition of User</h1>
