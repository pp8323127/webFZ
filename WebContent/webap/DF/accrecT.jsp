...
int tld = 0;
int tln = 0;
String Recordset1__myempn = "632902";
if (request.getParameter("empno")   !=null) {Recordset1__myempn = (String)request.getParameter("empno")  ;}

String Recordset1__myyear = "2005";
if (request.getParameter("year") !=null) {Recordset1__myyear = (String)request.getParameter("year");}

String Recordset1__mymonth = "5";
...
try{
	...
	conn  = dbDriver.connect(cn.getConnURL(), null);
		...
		%>
		<%
		String Recordset2__myempn = "632902";
		if (request.getParameter("empno")   !=null) {Recordset2__myempn = (String)request.getParameter("empno")  ;}
		%>
		<%
		...
		%>
		<%
		String Thisyear__myempn = "632902";
		if (request.getParameter("empno") !=null) {Thisyear__myempn = (String)request.getParameter("empno");}
		%>
		<%
		Thisyear__myyear = "2002";
		if (request.getParameter("year") !=null) {Thisyear__myyear = (String)request.getParameter("year");}
		%>
		<%
		String Thisyear__mymonth = "1";
		if (request.getParameter("month") !=null) {Thisyear__mymonth = (String)request.getParameter("month");}
		%>
		<%
		...
		String Thismonth__myempn = "632902";
		if (request.getParameter("empno") !=null) {Thismonth__myempn = (String)request.getParameter("empno");}

		String Thismonth__myyear = "2000";
		if (request.getParameter("year")  !=null) {Thismonth__myyear = (String)request.getParameter("year") ;}

		String Thismonth__mymonth = "8";
		if (request.getParameter("month")  !=null) {Thismonth__mymonth = (String)request.getParameter("month") ;}
		...
		%>
		<%
		String Acctotal__myempn = "636018";
		if (request.getParameter("empno") !=null) {Acctotal__myempn = (String)request.getParameter("empno");}
		%>
		<%
		String Acctotal__myyear = "2002";
		if (request.getParameter("year") !=null) {Acctotal__myyear = (String)request.getParameter("year");}
		%>
		<%
		String Acctotal__mymonth = "5";
		if (request.getParameter("month") !=null) {Acctotal__mymonth = (String)request.getParameter("month");}
		%>
		<%
		...
		%>
		<%
		String Yeartotal__myempn = "636018";
		if (request.getParameter("empno") !=null) {Yeartotal__myempn = (String)request.getParameter("empno");}
		%>
		<%
		String Yeartotal__myyear = "2002";
		if (request.getParameter("year") !=null) {Yeartotal__myyear = (String)request.getParameter("year");}
		%>
		<%
		String Yeartotal__mymonth = "5";
		if (request.getParameter("month") !=null) {Yeartotal__mymonth = (String)request.getParameter("month");}
		%>
		<%
		...
		%>
		<%
		String Monthtotal__myempn = "636018";
		if (request.getParameter("empno") !=null) {Monthtotal__myempn = (String)request.getParameter("empno");}
		%>
		<%
		String Monthtotal__myyear = "2002";
		if (request.getParameter("year") !=null) {Monthtotal__myyear = (String)request.getParameter("year");}
		%>
		<%
		String Monthtotal__mymonth = "5";
		if (request.getParameter("month") !=null) {Monthtotal__mymonth = (String)request.getParameter("month");}
		%>
		<%
		...
		%>
		<%
		String Monthtold__myempn = "636018";
		if (request.getParameter("empno") !=null) {Monthtold__myempn = (String)request.getParameter("empno");}
		%>
		<%
		String Monthtold__myyear = "2002";
		if (request.getParameter("year") !=null) {Monthtold__myyear = (String)request.getParameter("year");}
		%>
		<%
		String Monthtold__mymonth = "5";
		if (request.getParameter("month") !=null) {Monthtold__mymonth = (String)request.getParameter("month");}
		%>
		<%
		...
		%>
		<%
		String Acccafototal__myempn = "636018";
		if (request.getParameter("empno") !=null) {Acccafototal__myempn = (String)request.getParameter("empno");}
		%>
		<%
		String Acccafototal__myyear = "2002";
		if (request.getParameter("year") !=null) {Acccafototal__myyear = (String)request.getParameter("year");}
		%>
		<%
		String Acccafototal__mymonth = "5";
		if (request.getParameter("month") !=null) {Acccafototal__mymonth = (String)request.getParameter("month");}
		%>
		<%
		...
		%>
		<%
		String Monthstold__myempn = "636018";
		if (request.getParameter("empno") !=null) {Monthstold__myempn = (String)request.getParameter("empno");}
		%>
		<%
		String Monthstold__myyear = "2002";
		if (request.getParameter("year") !=null) {Monthstold__myyear = (String)request.getParameter("year");}
		%>
		<%
		String Monthstold__mymonth = "5";
		if (request.getParameter("month") !=null) {Monthstold__mymonth = (String)request.getParameter("month");}
		%>
		<%
...
<div align="center"><font face="Arial, Helvetica, sans-serif" size="3"><strong>China 
  Airlines Cockpit Crew Personal Record</strong></font> (test) </div>
  ...
  <!--  THIS YEAR -->
	...
	<% if (Thisyear_hasData==false) { %> No Recrods <% } else { %>   
		<table border="1" width="100%" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr> 
			...
			<td width="7%"> 
			  <div align="right"><font size="2" face="Arial, Helvetica, sans-serif">test</font></div>
			</td>
			<td width="7%"> 
...
<!--  THIS MONTH -->
	<% if (Thismonth_hasData==false) { %> No Recrods <% } else { %>   
		<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr> 
			...
			<td width="7%"> 
			  <div align="right"><font face="Arial, Helvetica, sans-serif" size="2"><%=(((Thismonth_data = Thismonth.getObject("TCA"))==null || Thismonth.wasNull())?"":Thismonth_data)%>:<%=(((Thismonth_data = Thismonth.getObject("MCA"))==null || Thismonth.wasNull())?"":Thismonth_data)%></font></div>
			</td>
			<td width="7%"> 
	...
	<%  }  // if (Thismonth_hasData!=false)   %>		
		...
		2000/01</font>
		<br>
		<font face="Arial, Helvetica, sans-serif" size="2">PIC(U/S) record from 2005/01/01</font></p>
		</body>
		</html>
<%
}
