...
PreparedStatement StatementRecordset1 = ConnRecordset1.prepareStatement("SELECT *  FROM DFTUSGP  ORDER BY USERID ASC");
...
<html>
<head>
<title>User Groups List</title>
<meta http-equiv="Content-Type" content="text/html; charset=big5">
<meta http-equiv="pragma" content="no-cache">
</head>
<body bgcolor="#FFFFFF" text="#000000" background="clearday.jpg">
<div align="center"> 
  <p><font face="Comic Sans MS" color="#333333">User Groups List</font></p>
  ...
  <table width="75%" border="0">
    ...
    <tr> 
      <td> 
        <div align="center"><font face="Arial, Helvetica, sans-serif" size="2"><A HREF="usrgroupdetail.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "userid=" + (((Recordset1_data = Recordset1.getObject("USERID"))==null || Recordset1.wasNull())?"":Recordset1_data)+"&groupcd=" + (((Recordset1_data = Recordset1.getObject("GROUPCD"))==null || Recordset1.wasNull())?"":Recordset1_data) %>"><%=(((Recordset1_data = Recordset1.getObject("USERID"))==null || Recordset1.wasNull())?"":Recordset1_data)%></A></font></div>
      </td>
      <td> 
        <div align="center"><font face="Arial, Helvetica, sans-serif" size="2"><%=(((Recordset1_data = Recordset1.getObject("GROUPCD"))==null || Recordset1.wasNull())?"":Recordset1_data)%></font></div>
      </td>
      <td> 
...
%>
  ...
  <p><a href="addusrgroup.jsp">New User Group</a></p>
</div>
</body>
</html>
<%
