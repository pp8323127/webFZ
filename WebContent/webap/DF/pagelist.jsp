...
PreparedStatement StatementRecordset2 = ConnRecordset2.prepareStatement("SELECT *  FROM DFTPAGE  ORDER BY PAGEID ASC");
...
<div align="center"> 
  <table width="90%" border="1">
    <tr> 
      <td colspan="2"> 
        <div align="center"><b><font size="2" face="Comic Sans MS" color="#000066">Page 
          Items list</font></b></div>
      </td>
      <td colspan="2"> 
        <div align="center"><b><font size="2" face="Comic Sans MS" color="#000066">Page 
          Authorize list</font></b></div>
      </td>
      <td colspan="2"> 
        <div align="center"><b><font size="2" face="Comic Sans MS" color="#000066">Group 
          Items list</font></b></div>
      </td>
    </tr>
    <tr> 
      ...
      <td width="17%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif" size="2"><a href="addpageitem.jsp">new 
          page</a></font></div>
      </td>
      <td width="17%"><font face="Arial, Helvetica, sans-serif" size="2">total 
        : <%=(Recordset2_total)%></font></td>
      <td width="17%"> 
        <div align="right"><font face="Arial, Helvetica, sans-serif" size="2"><a href="addpageauth.jsp">new 
          pageauth</a></font></div>
      </td>
      <td width="17%"><font face="Arial, Helvetica, sans-serif" size="2">total 
    ...
    <tr valign="top"> 
      <td colspan="2"> 
        <table width="100%" border="0">
          ...
          <tr> 
            <td> 
              <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><A HREF="pageitemdetail.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "pageid=" + (((Recordset1_data = Recordset1.getObject("PAGEID"))==null || Recordset1.wasNull())?"":Recordset1_data) %>"><%=(((Recordset1_data = Recordset1.getObject("PAGEID"))==null || Recordset1.wasNull())?"":Recordset1_data)%></A></font></div>
            </td>
            <td> 
              <div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><%=(((Recordset1_data = Recordset1.getObject("PAGENAME"))==null || Recordset1.wasNull())?"":Recordset1_data)%></font></div>
            </td>
            <td> 
              <div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><%=(((Recordset1_data = Recordset1.getObject("COMMENTS"))==null || Recordset1.wasNull())?"":Recordset1_data)%></font></div>
            </td>
          </tr>
          <%
  Repeat1__index++;
      ...
      <td colspan="2"> 
        <table width="100%" border="0">
          <tr bgcolor="#99CCFF"> 
            ...
            <td> 
              <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Authorize</font></b></div>
            </td>
            <td> 
              <div align="center"><b><font face="Arial, Helvetica, sans-serif" size="2">Comments</font></b></div>
            </td>
          ...
          <tr> 
            <td> 
              <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><A HREF="pagedetail.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "pageid=" + (((Recordset2_data = Recordset2.getObject("PAGEID"))==null || Recordset2.wasNull())?"":Recordset2_data) + "&groupcd=" + (((Recordset2_data = Recordset2.getObject("GROUPCD"))==null || Recordset2.wasNull())?"":Recordset2_data) %>"><%=(((Recordset2_data = Recordset2.getObject("PAGEID"))==null || Recordset2.wasNull())?"":Recordset2_data)%></A></font></div>
            </td>
            <td> 
              <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><%=(((Recordset2_data = Recordset2.getObject("GROUPCD"))==null || Recordset2.wasNull())?"":Recordset2_data)%></font></div>
            </td>
            <td> 
              <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><%=(((Recordset2_data = Recordset2.getObject("AUTH"))==null || Recordset2.wasNull())?"":Recordset2_data)%></font></div>
            </td>
            <td> 
              <div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><%=(((Recordset2_data = Recordset2.getObject("COMMENTS"))==null || Recordset2.wasNull())?"":Recordset2_data)%></font></div>
            </td>
          </tr>
          <%
  Repeat2__index++;
...
%>
      ...
      <td colspan="2"> 
        <table width="100%" border="0">
          ...
          <tr> 
            <td> 
              <div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><A HREF="groupitemdetail.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "groupcd=" + (((Recordset3_data = Recordset3.getObject("GROUPCD"))==null || Recordset3.wasNull())?"":Recordset3_data) %>"><%=(((Recordset3_data = Recordset3.getObject("GROUPCD"))==null || Recordset3.wasNull())?"":Recordset3_data)%></A></font></div>
            </td>
            <td> 
              <div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><%=(((Recordset3_data = Recordset3.getObject("GROUPNAME"))==null || Recordset3.wasNull())?"":Recordset3_data)%></font></div>
            </td>
            <td> 
              <div align="left"><font size="2" face="Arial, Helvetica, sans-serif"><%=(((Recordset3_data = Recordset3.getObject("COMMENTS"))==null || Recordset3.wasNull())?"":Recordset3_data)%></font></div>
            </td>
          </tr>
          <%
  Repeat3__index++;
